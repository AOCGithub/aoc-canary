    ...
    <div className={clsx('w-full', className)}>
      ...
      <SelectPrimitive.Root {...rest} name={`${name}_display`} required={required} value={value}>
        <SelectPrimitive.Trigger
          aria-label={label}
          className={clsx(
            'flex h-fit w-full select-none items-center justify-between gap-3 border p-2 px-5 text-sm transition-colors focus-visible:outline-none focus-visible:ring-2 border-[#224086] !text-[#224086] font-[Rubik] rounded-[3px] py-[6px] font-[800]',
